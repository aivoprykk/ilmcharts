...
const pkg = JSON.parse(require('fs').readFileSync(process.env.npm_package_json).toString());
module.exports = {
    ...
    plugins: [
        new HtmlBundlerPlugin({
            entry: [
                ...
                {
                    import: __dirname + '/src/pug/index.pug', // => dist/index.html
                    filename: 'index.html',
                    dev: !isProd,
                    data: { 
                        opt: {
                            title: 'Ilmajaam',
                            name: pkg.name || 'Ilmajaam',
